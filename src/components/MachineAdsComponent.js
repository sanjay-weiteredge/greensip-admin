...
const MachineAdsComponent = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Machine Form submitted:', formData);
  ...
  return (
    <form onSubmit={handleSubmit} style={formContainerStyle}>
      <div style={gridContainerStyle}>
        ...
        <div style={formGroupStyle}>
          <label style={labelStyle}>Video or Image Upload</label>
          <input
            type="file"
            name="media"
            onChange={handleInputChange}
        ...
        <div style={formGroupStyle}>
          <label style={labelStyle}>Ad's Budget</label>
          <input
            type="number"
            name="budget"
            ...
            onChange={handleInputChange}
            style={inputStyle}
            placeholder="Enter ad's budget in Rs"
            min="0"
            step="10"
            required
          />
